...
-->
<title>DESDM</title>
<h2><a href="#"><center>UPDATE PROFESSORS INFORMATION</center></a></h2>
<center>
<div class="articles">
...
echo "<tr bgcolor='#336699'>
    <th><font color='#fff'>Professors's Name</font></th>
...
while($row=mysql_fetch_array($result))
	...
	echo "<td><center><a href=UpdateTeacherInformation.php?id=$row[index]><input type='submit' name='Submit' value='Update'/></a><a href=DeleteTeacherInformation.php?id=$row[index]><input type='submit' name='Submit' value='Delete'/></a></center></td>";
	echo "</tr>";	
	}
	echo "</table>";
	mysql_close($con);
