...
echo "<tr bgcolor='#336699'>
    <th><font color='#ffffff'>Student's Name</font></th>
	<th><font color='#ffffff'>Reg. NO</font></th>
	<th><font color='#ffffff'>Session</font></th>
...
while($row=mysql_fetch_array($result))
	...
	echo "<td>{$row['ses']}</td>";
	echo "<td><center><a href=UpdateAlumni.php?id=$row[index]><input type='submit' name='Submit' value='Update'/></a><a href=DeleteAlumni.php?id=$row[index]><input type='submit' name='Submit' value='Delete'/></a></center></td>";
	echo "</tr>";
	}
	echo "</table>";
	mysql_close($con);
