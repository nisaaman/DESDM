...
<h2><a href="#"><center>UPDATE CIVIL DEFENC</center></a></h2>
<p><marquee><font color="#87CEEB" size="+2" face="Georgia"><b>UPDATE GENERAL STIPEND</b></font></marquee></p>
<?
...
$index=$_POST['index'];
$txt=$_POST['txt'];
	  $sql = "UPDATE $civil_def SET `txt`='$txt' where `index` LIKE '$index'";
...
if(isset($_GET['id'])){
	  $id=$_GET['id'];
include('..\connection.php');
$sql = "SELECT * FROM  `civil_def` where `index` LIKE '$id'";
$s=mysql_query($sql);
...
<p><h3><u><a href="Update&DeleteCivilDefence.php">Back</a></u></h3> </p>
