...
<p><marquee><font color="#87CEEB" size="+2" face="Georgia"><b>INSERT WEATHER STATUS</b></font></marquee></p>
 <form action="RegisterWeatherStatus.php" method="post"> 
    
     	 
	   Date: <input type='text'  name="date" id="inputField" />
		<br/><br/>
	
		<class="label">Context text:
      
          <div class="field_container">
              <textarea name="txt" id="eml" name="eml" rows="15" cols="10" style="width: 80%">
