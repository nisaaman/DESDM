...
<h2><a href="#"><center>UPDATE PHYSICAL TRAINING</center></a></h2>
<p><marquee><font color="#87CEEB" size="+2" face="Georgia"><b>UPDATE PHYSICAL TRAINING</b></font></marquee></p>
<?
...
$index=$_POST['index'];
$txt=$_POST['txt'];
	  $sql = "UPDATE $phy_trn SET `txt`='$txt' where `index` LIKE '$index'";
...
if(isset($_GET['id'])){
	  $id=$_GET['id'];
include('..\connection.php');
$sql = "SELECT * FROM  `phy_trn` where `index` LIKE '$id'";
$s=mysql_query($sql);
...
<p><h3><u><a href="Update&DeletePhysicalTraining.php">Back</a></u></h3> </p>
