...
<h2><a href="#"><center>PHYSICAL TRAINING</center></a></h2>
<p><marquee><font color="#87CEEB" size="+2" face="Georgia"><b>INSERT PHYSICAL TRAINING</b></font></marquee></p>

    <table class="editor" border="0" cellspacing="10" >
      <tbody>
      <form action="RegisterPhysicalTraining.php" method="post"> 
		<tr> 
		<td class="label">Context text:</td>
        </tr> 
            </tbody>
    </table>
