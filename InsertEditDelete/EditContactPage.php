...
<h2>Contact Page Text & Image Edit</h2>

<p><marquee><font color="#87CEEB" size="+2" face="Georgia"><b>Edit Contact Page</b></font></marquee></p><br />
<?
if (isset($_POST['id']))
{
...
if(copy($_FILES['fupload']['tmp_name'], "../upload\\ct"."_pic1".".jpg"))
		print "";
		else
		print "";
	}
...
if(copy($_FILES['fupload1']['tmp_name'], "../../upload\\ct"."_pic2".".jpg"))
		print "";
		else
		print "";
	}
include('..\connection.php');
$sql="UPDATE `AdmissionProsessResearch&JournalsLaboratoriesNoticeBoard&Contact` SET `ContactTxt`='$_POST[txt]'";
...
<input type="hidden" name="id" value="<? print "$a[id]";?>"/> 
   ...
   <input type="file" name="fupload" id="fupload" />
	...
	<textarea name="txt" id="elm" name="elm" rows="15" cols="80" style="width: 80%"><? print "$a[ContactTxt]";?>
