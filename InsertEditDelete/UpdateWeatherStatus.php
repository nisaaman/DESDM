...
<h2><a href="#"><center>UPDATE WEATHER STATUS</center></a></h2>
<p><marquee><font color="#87CEEB" size="+2" face="Georgia"><b>UPDATE WEATHER STATUS</b></font></marquee></p>
<?
...
$date=$_POST['date'];
$txt=$_POST['txt'];
	  $sql = "UPDATE $ws SET `txt`='$txt',`date`='$date' where `index` LIKE '$index'";
...
if(isset($_GET['id'])){
	  $id=$_GET['id'];
include('..\connection.php');
$sql = "SELECT * FROM  `ws` where `index` LIKE '$id'";
$s=mysql_query($sql);
