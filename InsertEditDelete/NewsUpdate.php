...
<h2>Update News Text</h2>
<p><marquee><font color="#87CEEB" size="+2" face="Georgia"><b>Edit Update News</b></font></marquee></p><br />

<?
if (isset($_POST['id']))
{
include('../connection.php');
$sql="UPDATE nwup SET txt='$_POST[txt]'";
