...
<h2><a href="#"><center>UPDATE GENERAL STIPEND</center></a></h2>
...
$index=$_POST['index'];
$txt=$_POST['txt'];
	  $sql = "UPDATE $gs SET `txt`='$txt' where `index` LIKE '$index'";
...
if(isset($_GET['id'])){
	  $id=$_GET['id'];
include('..\connection.php');
$sql = "SELECT * FROM  `gs` where `index` LIKE '$id'";
$s=mysql_query($sql);
...
<p><h3><u><a href="Update&DeleteGeneralStipend.php">Back</a></u></h3> </p>
