...
<body>
<h1><a href="#"><center>UPDATE MAJOR & RECENT DISASTER INFORMATION</center></a></h1>
<p><marquee><font color="#87CEEB" size="+2" face="Georgia"><b>UPDATE MAJOR & RECENT DISASTER INFORMATION</b></font></marquee></p>
...
$status=$_POST['status'];
$srt_ti=$_POST['srt_ti'];
$sort_dis=$_POST['sort_dis'];
$discrip=$_POST['discrip'];

if ( isset($_FILES['fupload'])) {
	$file_name = $_FILES['fupload']['name'];
	$file_type = $_FILES['fupload']['type'];
if(copy($_FILES['fupload']['tmp_name'],"../RecentDisaster/upload\\$srt_ti"."_pic1".".jpg"))
		print "";
		else
		print "";
	}
...
if(copy($_FILES['fupload1']['tmp_name'],"../RecentDisaster/upload\\$srt_ti"."_pic2".".jpg"))
		print "";
		else
		print "";
	}
...
if(copy($_FILES['fupload2']['tmp_name'],"../RecentDisaster/upload\\$srt_ti"."_pic3".".jpg"))
		print "";
		else
		print "";
	}
...
if(copy($_FILES['fupload3']['tmp_name'],"../RecentDisaster/upload\\$srt_ti"."_pic4".".jpg"))
		print "";
		else
		print "";
	}
...
if(copy($_FILES['fupload4']['tmp_name'],"../RecentDisaster/upload\\$srt_ti"."_pic5".".jpg"))
		print "";
		else
		print "";
	}
	  $sql = "UPDATE $disaster SET `date`='$date', `title`='$title', `status`='$status',  `srt_ti`='$srt_ti', `sort_dis`='$sort_dis', `discrip`='$discrip' where `index` LIKE '$index'";
...
include('..\connection.php');
$disaster="disaster";
$sql = "SELECT * FROM  `disaster` where `index` LIKE '$id'";
$s=mysql_query($sql);
...
<form action="<? $_SERVER['PHP_SELF'];?>"  method="post" enctype="multipart/form-data" name="form2" id="form2">
  <input type="hidden" name="index" value="<? print "$a[index]";?>"/>
	<table class="editor" border="0" cellspacing="10" width="100%">
      <tbody>
         <tr>
		...
		<tr>
          ...
          <td><div class="field_container">
                       <textarea name="sort_dis" id="sort_dis" name="sort_dis" rows="15" cols="10" style="width: 80%"><? print "$a[sort_dis]";?>
	...
	<tr> 
          ...
          <div class="field_container">
              <textarea name="discrip" id="discrip" name="discrip" rows="15" cols="10" style="width: 80%"><? print "$a[discrip]";?>
	
	</textarea>
          </div>
<table class="editor" border="0" cellspacing="5" >
   	<tr>
...
<p> <h3><u><a href="Update&DeleteRecentDisasterInformation.php">Back</a></u></h3> </p>
